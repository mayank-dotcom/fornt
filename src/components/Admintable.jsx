...
import EditInternPopup from "./EditInternPopup";
...
function Admintable() {
  ...
  const handleInternSelection = (id) => {
  ...
  const getUniqueNames = () => {
    const names = [...new Set(filteredData.map((item) => item.name))];
    return names.sort();
  };
      ...
      <div className="container-fluid py-4">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <select
              ...
              onChange={(e) => handleInternSelection(e.target.value)}
            >
              <option value="">Select Intern</option>
              <option value="">Add New Intern</option>
